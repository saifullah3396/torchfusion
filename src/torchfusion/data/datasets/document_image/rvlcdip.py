...
_METADATA_URLS = {
    ...
    "tobacco3482_excluded": {
        "train": "https://huggingface.co/datasets/sasa3396/rvlcdip/resolve/main/data/tobacco3482_excluded/train.txt",
        "test": "https://huggingface.co/datasets/sasa3396/rvlcdip/resolve/main/data/tobacco3482_excluded/test.txt",
...
class RvlCdip(FusionImageDataset):
    ...
    BUILDER_CONFIGS = [
        ...
        RvlCdipConfig(
            ...
            image_url=_URLS[_IMAGE_DATA_NAME],
            ocr_url=_URLS[_OCR_DATA_NAME],
            metadata_urls=_METADATA_URLS["tobacco3482_excluded"],
            use_auth_token=True,
        ),
        RvlCdipConfig(
            name="tobacco3482_excluded_with_ocr",
            description=_DESCRIPTION
            + " Tobaco3482 overalp is removed from the dataset.",
            homepage=_HOMEPAGE,
            citation=_CITATION,
    ...
    def _generate_examples_impl(self, labels_filepath, shard=None, num_shards=None):
        ...
        for item in data:
            try:
                ...
                if self.config.load_ocr:
                    from torchfusion.utilities.text_utilities import TesseractOCRReader
