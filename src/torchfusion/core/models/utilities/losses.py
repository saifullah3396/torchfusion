...
class EntLoss(nn.Module):
    ...
    def forward(self, features_1, features_2, use_queue=False):
        ...
        sharpened_probs1 = torch.nn.functional.softmax(features_1_dist / self.tau, dim=-1)
        sharpened_probs2 = torch.nn.functional.softmax(features_2_dist / self.tau, dim=-1)
