...
class FusionFolderBasedDatasetConfig(FusionDatasetConfig):
    """BuilderConfig for FusionFolderBasedDataset"""
...
class FusionFolderBasedDataset(FusionDataset):
    BASE_FEATURE: Type[FeatureType]
    BASE_COLUMN_NAME: str
    BUILDER_CONFIG_CLASS: FusionFolderBasedDatasetConfig
    EXTENSIONS: List[str]
    ...
    BUILDER_CONFIGS = [
        FusionFolderBasedDatasetConfig(
            ...
            description="Default FolderBased classification dataset config",
        ),
    ]
    ...
    def _generate_examples_impl(self, files, metadata_files, split_name, add_metadata, add_labels):
